    ...
    <article class="max-w-2xl mx-auto">
      ...
      <header class="mb-12">
        <div class="flex items-baseline justify-between gap-4 mb-4">
          ...
          <button
            type="button"
            class="cursor-pointer inline-flex items-center gap-2 font-mono text-sm text-fg-muted hover:text-fg transition-colors duration-200 rounded ring-focus-visible shrink-0 p-1.5 -mx-1.5"
            @click="router.back()"
            v-if="canGoBack"
          >
          ...
          <div class="bg-bg-subtle border border-border rounded-lg p-4 sm:p-6 space-y-4">
            ...
            <template v-else>
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                class="inline-flex items-center gap-2 text-sm text-fg-muted hover:text-fg transition-colors duration-200 ring-focus-visible rounded"
              >
