          ...
          <div class="space-y-1 sm:col-span-3">
            <dt class="text-xs text-fg-subtle uppercase tracking-wider flex items-center gap-1">
              ...
              <TooltipApp v-if="sizeTooltip" :text="sizeTooltip">
                <span
                  tabindex="0"
                  class="inline-flex items-center justify-center min-w-6 min-h-6 -m-1 p-1 text-fg-subtle cursor-help ring-focus-visible rounded"
                >
              ...
              >
                <template #provenance>
                  <a
                    ...
                    class="inline-flex items-center gap-1 rounded-sm underline underline-offset-4 decoration-amber-600/60 dark:decoration-amber-400/50 hover:decoration-fg focus-visible:(decoration-accent) ring-focus-visible transition-colors"
      ...
      <section id="readme" class="min-w-0 scroll-mt-20" :class="$style.areaReadme">
        ...
        <p v-else class="text-fg-muted italic">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            class="link text-fg underline underline-offset-4 decoration-fg-subtle hover:(decoration-fg text-fg) transition-colors duration-200 focus-visible:(decoration-accent) ring-focus-visible"
