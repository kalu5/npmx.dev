...
<template>
  <div ref="dropdownRef" class="relative">
    <button
      ...
      class="flex items-center gap-1.5 text-fg-subtle font-mono text-sm hover:text-fg transition-[color] outline-none focus-visible:(ring-2 ring-accent/90) focus-visible:ring-offset-bg rounded"
      @click="isOpen = !isOpen"
