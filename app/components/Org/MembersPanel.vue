    ...
    <div class="flex flex-wrap items-center gap-2 p-3 border-b border-border bg-bg">
      ...
      >
        <button
          ...
          :key="role"
          type="button"
          class="px-2 py-1 font-mono text-xs rounded transition-colors duration-200 outline-none focus-visible:(ring-2 ring-accent/90)"
      ...
      >
        ...
        <div v-if="member.teams.length > 0" class="flex flex-wrap gap-1 ps-0">
          <button
            ...
            :key="team"
            type="button"
            class="inline-flex items-center gap-1 px-1.5 py-0.5 font-mono text-xs text-fg-muted border border-border rounded hover:text-fg hover:border-border-hover transition-colors duration-200 outline-none focus-visible:(ring-2 ring-accent/90)"
