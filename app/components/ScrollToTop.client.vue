...
<template>
  ...
  <button
    ...
    type="button"
    class="scroll-to-top-css fixed bottom-4 inset-ie-4 z-50 w-12 h-12 bg-bg-elevated border border-border rounded-full shadow-lg flex items-center justify-center text-fg-muted hover:text-fg transition-colors active:scale-95 ring-focus-visible"
  ...
  >
    <button
      ...
      type="button"
      class="fixed bottom-4 inset-ie-4 z-50 w-12 h-12 bg-bg-elevated border border-border rounded-full shadow-lg flex items-center justify-center text-fg-muted hover:text-fg transition-colors active:scale-95 ring-focus-visible"
      :aria-label="$t('common.scroll_to_top')"
      @click="scrollToTop"
    >
      <span class="i-lucide:arrow-up w-5 h-5" aria-hidden="true" />
