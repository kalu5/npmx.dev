...
<template>
  ...
  >
    <button
      type="button"
      class="inline-flex items-center px-2.5 py-1.5 text-sm font-medium rounded-sm transition-colors duration-200 outline-none focus-visible:(ring-2 ring-accent/90)"
