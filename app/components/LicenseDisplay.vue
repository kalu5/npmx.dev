  ...
  <span class="inline-flex items-baseline gap-x-1.5 flex-wrap gap-y-0.5">
    <template v-for="(token, i) in tokens" :key="i">
      <a
        ...
        class="link-subtle hover:(underline-offset-[0.2rem] underline decoration-1 decoration-accent text-accent) outline-none focus-visible:(ring-2 ring-accent/90) transition-colors duration-200"
