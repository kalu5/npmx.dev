    ...
    <div v-else-if="publishSuccess" class="space-y-4">
      ...
      <div class="flex gap-3">
        <NuxtLink
          ...
          class="flex-1 px-4 py-2 font-mono text-sm text-center text-bg bg-fg rounded-md transition-colors duration-200 hover:bg-fg/90 outline-none focus-visible:(ring-2 ring-accent/90)"
          @click="close"
        >
        ...
        <button
          type="button"
          class="flex-1 px-4 py-2 font-mono text-sm text-fg-muted bg-bg-subtle border border-border rounded-md transition-colors duration-200 hover:text-fg hover:border-border-hover outline-none focus-visible:(ring-2 ring-accent/90)"
          @click="close"
        >
          {{ $t('common.close') }}
        </button>
    ...
    <div v-else-if="checkResult" class="space-y-4">
            ...
            >
              ...
              <div class="min-w-0">
                <NuxtLink
                  ...
                  class="font-mono text-sm text-fg hover:underline outline-none focus-visible:(ring-2 ring-accent/90) rounded"
                  target="_blank"
                >
                  {{ pkg.name }}
                </NuxtLink>
      ...
      <div v-if="checkResult.available && checkResult.valid" class="space-y-3">
        ...
        <div v-if="!isConnected" class="space-y-3">
          ...
          <button
            type="button"
            class="w-full px-4 py-2 font-mono text-sm text-bg bg-fg rounded-md transition-colors duration-200 hover:bg-fg/90 outline-none focus-visible:(ring-2 ring-accent/90)"
        ...
        <div v-else-if="isConnected && canPublishToScope" class="space-y-3">
          ...
          <button
            ...
            class="w-full px-4 py-2 font-mono text-sm text-bg bg-fg rounded-md transition-colors duration-200 hover:bg-fg/90 disabled:opacity-50 disabled:cursor-not-allowed outline-none focus-visible:(ring-2 ring-accent/90)"
            @click="handleClaim"
          >
      ...
      <button
        ...
        type="button"
        class="w-full px-4 py-2 font-mono text-sm text-fg-muted bg-bg-subtle border border-border rounded-md transition-colors duration-200 hover:text-fg hover:border-border-hover outline-none focus-visible:(ring-2 ring-accent/90)"
        @click="close"
      >
        {{ $t('common.close') }}
      </button>
