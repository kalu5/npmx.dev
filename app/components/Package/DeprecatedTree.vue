    ...
    <div class="rounded-lg border overflow-hidden" :class="bannerColor">
      ...
      >
          ...
          >
            <div class="flex items-center gap-2 mb-1">
              ...
              <NuxtLink
                ...
                class="font-mono text-sm font-medium hover:underline truncate py-4 outline-none focus-visible:(ring-2 ring-accent/90)"
        ...
        <button
          ...
          type="button"
          class="w-full px-4 py-2 text-xs font-mono text-fg-muted hover:text-fg border-t border-border transition-colors duration-200 outline-none focus-visible:(ring-2 ring-accent/90)"
          @click="showAll = true"
        >
          {{
