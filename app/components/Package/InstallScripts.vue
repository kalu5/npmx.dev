...
<template>
  ...
  >
    ...
    <div v-if="hasNpxDeps" class="mt-3">
      <button
        type="button"
        class="flex items-center gap-1.5 text-xs text-fg-muted hover:text-fg transition-colors duration-200 outline-none focus-visible:(ring-2 ring-accent/90) rounded"
