  ...
  >
    ...
    <div class="space-y-0.5 min-w-0">
      ...
      <div>
        <div class="flex items-center gap-2 p-1">
          ...
          <TooltipApp interactive position="top">
            <span
              tabindex="0"
              class="block cursor-help shrink-0 -m-2 p-2 -me-1 inset-focus-visible rounded"
            >
              <span
      ...
      <div v-for="row in visibleTagRows" :key="row.id">
        ...
        >
          ...
          <button
            ...
            type="button"
            class="size-5 -me-1 flex items-center justify-center text-fg-subtle hover:text-fg transition-colors rounded-sm relative z-10 ring-focus-visible"
      ...
      <div class="p-1">
        <button
          type="button"
          class="flex items-center gap-2 text-start rounded-sm w-full ring-focus-visible"
              ...
              >
                <div class="flex items-center justify-between gap-2">
                  <div class="flex items-center gap-2 min-w-0">
                    <button
                      type="button"
                      class="w-4 h-4 flex items-center justify-center text-fg-subtle hover:text-fg transition-colors shrink-0 rounded-sm relative z-10 ring-focus-visible"
