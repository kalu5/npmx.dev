    ...
    <table class="w-full text-start">
      <thead class="border-b border-border">
        <tr>
          ...
          <th
            scope="col"
            class="py-3 px-3 text-xs text-start text-fg-muted font-mono font-medium uppercase tracking-wider whitespace-nowrap select-none inset-focus-visible"
            :class="{
          ...
          <th
            ...
            scope="col"
            class="py-3 px-3 text-xs text-start text-fg-muted font-mono font-medium uppercase tracking-wider whitespace-nowrap select-none text-end inset-focus-visible"
            :class="{
