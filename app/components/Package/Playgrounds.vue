    ...
    <div ref="dropdownRef" class="relative">
      ...
      <TooltipApp v-if="hasSingleLink && firstLink" :text="firstLink.providerName" class="w-full">
        <a
          ...
          class="w-full flex items-center gap-2 px-3 py-2 text-sm font-mono bg-bg-muted border border-border rounded-md hover:border-border-hover hover:bg-bg-elevated ring-focus-visible transition-colors duration-200"
        >
          <span
      ...
      <button
        ...
        class="w-full flex items-center justify-between gap-2 px-3 py-2 text-sm font-mono bg-bg-muted border border-border rounded-md hover:border-border-hover hover:bg-bg-elevated ring-focus-visible transition-colors duration-200"
        @click="isOpen = !isOpen"
        ...
        >
          <TooltipApp v-for="link in links" :key="link.url" :text="link.providerName" class="block">
            <a
              ...
              rel="noopener noreferrer"
              role="menuitem"
              class="flex items-center gap-2 px-3 py-2 text-sm font-mono text-fg-muted hover:text-fg hover:bg-bg-muted ring-focus-visible focus-visible:text-fg focus-visible:bg-bg-muted transition-colors duration-150"
              @click="closeDropdown"
            >
              <span
