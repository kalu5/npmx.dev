      ...
      >
        ...
        <div class="flex items-center gap-1 shrink-0 order-1 sm:order-1">
          ...
          <button
            ...
            type="button"
            class="p-1.5 rounded border border-border bg-bg-subtle text-fg-muted hover:text-fg hover:border-border-hover transition-colors duration-200 outline-none focus-visible:(ring-2 ring-accent/90)"
