  ...
  <Modal :modal-title="$t('package.skills.title')" id="skills-modal" class="sm:max-w-2xl">
    ...
    <div class="flex flex-wrap items-center justify-between gap-2 mb-3">
      ...
      >
        <button
          ...
          type="button"
          class="px-2 py-1 font-mono text-xs rounded transition-colors duration-150 border border-solid outline-none focus-visible:(ring-2 ring-accent/90)"
          :class="
    ...
    <ul class="space-y-0.5 list-none m-0 p-0">
      <li v-for="skill in skills" :key="skill.dirName">
        <button
          type="button"
          class="w-full flex items-center gap-2 py-1.5 text-start rounded transition-colors hover:bg-bg-subtle outline-none focus-visible:(ring-2 ring-accent/90)"
