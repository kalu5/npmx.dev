...
<template>
  <section v-if="isConnected && orgName">
    ...
    >
      ...
      >
        ...
        <button
          v-if="collab.isTeam"
          type="button"
          class="p-1 text-fg-subtle hover:text-red-400 transition-colors duration-200 shrink-0 rounded outline-none focus-visible:(ring-2 ring-accent/90)"
    ...
    <button
      v-else
      type="button"
      class="w-full px-3 py-1.5 font-mono text-xs text-fg-muted bg-bg-subtle border border-border rounded transition-colors duration-200 hover:text-fg hover:border-border-hover outline-none focus-visible:(ring-2 ring-accent/90)"
