  ...
  <div class="space-y-8">
    ...
    >
      ...
      <button
        ...
        type="button"
        class="my-2 ms-1 font-mono text-xs text-fg-muted hover:text-fg transition-colors duration-200 rounded outline-none focus-visible:(ring-2 ring-accent/90)"
    ...
    >
      ...
      <button
        ...
        type="button"
        class="mt-2 truncate outline-none focus-visible:(ring-2 ring-accent/90)"
