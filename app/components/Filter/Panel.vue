...
<template>
  <div class="border border-border rounded-lg bg-bg-subtle">
    ...
    <button
      type="button"
      class="w-full flex items-center gap-3 px-4 py-3 text-start hover:bg-bg-muted transition-colors duration-200 ring-focus-visible"
          ...
          <div class="flex items-center gap-3 mb-1">
            ...
            >
              <button
                ...
                :key="scope"
                type="button"
                class="px-2 py-0.5 text-xs font-mono rounded-sm border transition-colors duration-200 ring-focus-visible"
                :class="
        ...
        <fieldset v-if="displayedKeywords.length > 0" class="border-0 p-0 m-0 mt-4">
          ...
          <div class="flex flex-wrap gap-1.5" role="group" :aria-label="$t('filters.keywords')">
            ...
            <button
              ...
              type="button"
              class="text-xs text-fg-subtle self-center font-mono hover:text-fg transition-colors duration-200 ring-focus-visible"
