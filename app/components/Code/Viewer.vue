  ...
  <div class="code-viewer flex min-h-full max-w-full">
    ...
    >
      ...
      <a
        ...
        :href="`#L${lineNum}`"
        tabindex="-1"
        class="line-number block px-3 py-0 font-mono text-sm leading-6 cursor-pointer transition-colors no-underline outline-none focus-visible:(ring-2 ring-accent/90)"
        :class="[
