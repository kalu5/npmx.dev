...
<template>
  <div class="relative">
    ...
    <input
      ...
      "
      class="w-full px-2 py-1 font-mono text-sm bg-bg-subtle border border-border rounded text-fg placeholder:text-fg-subtle transition-colors duration-200 focus:border-border-hover outline-none focus-visible:(ring-2 ring-accent/90) disabled:opacity-50 disabled:cursor-not-allowed"
      @input="handleInput"
      @focus="handleFocus"
      @blur="handleBlur"
