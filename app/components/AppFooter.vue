    ...
    <div class="container py-3 sm:py-8 flex flex-col gap-2 sm:gap-4 text-fg-subtle text-sm">
      ...
      >
        ...
        <div class="hidden sm:flex items-center gap-6 min-h-11 text-xs">
          ...
          <button
            type="button"
            class="group inline-flex gap-x-1 items-center justify-center underline-offset-[0.2rem] underline decoration-1 decoration-fg/30 font-mono text-fg hover:(decoration-accent text-accent) focus-visible:(decoration-accent text-accent) ring-focus-visible transition-colors duration-200"
