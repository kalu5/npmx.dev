    ...
    <div class="bg-bg-subtle border border-border rounded-lg overflow-hidden">
      ...
      <div class="px-3 pt-2 pb-3 sm:px-4 sm:pt-3 sm:pb-4 space-y-1 overflow-x-auto" dir="ltr">
        ...
        >
          ...
          <button
            type="button"
            class="px-2 py-0.5 font-mono text-xs text-fg-muted bg-bg-subtle/80 border border-border rounded transition-colors duration-200 opacity-0 group-hover/installcmd:opacity-100 hover:(text-fg border-border-hover) active:scale-95 focus-visible:(opacity-100) ring-focus-visible select-none"
        ...
        <template v-if="devDependencySuggestion.recommended">
          ...
          >
            ...
            <ButtonBase
              type="button"
              size="small"
              class="text-fg-muted bg-bg-subtle/80 border-border opacity-0 group-hover/devinstallcmd:opacity-100 active:scale-95 focus-visible:(opacity-100) ring-focus-visible select-none"
        ...
        <template v-if="typesPackageName && showTypesInInstall">
          ...
          >
            ...
            <NuxtLink
              ...
              class="text-fg-subtle hover:text-fg-muted text-xs transition-colors ring-focus-visible rounded select-none"
        ...
        <template v-if="executableInfo?.hasExecutable">
          ...
          >
            ...
            <button
              type="button"
              class="px-2 py-0.5 font-mono text-xs text-fg-muted bg-bg-subtle/80 border border-border rounded transition-colors duration-200 opacity-0 group-hover/runcmd:opacity-100 hover:(text-fg border-border-hover) active:scale-95 focus-visible:(opacity-100) ring-focus-visible select-none"
        ...
        <template v-if="createPackageInfo">
          ...
          <div class="flex items-center gap-2 pt-1 select-none" dir="auto">
            ...
            >
              <NuxtLink
                ...
                class="inline-flex items-center justify-center min-w-6 min-h-6 -m-1 p-1 text-fg-muted hover:text-fg text-xs transition-colors ring-focus-visible rounded"
              >
          ...
          >
            ...
            <button
              type="button"
              class="px-2 py-0.5 font-mono text-xs text-fg-muted bg-bg-subtle/80 border border-border rounded transition-colors duration-200 opacity-0 group-hover/createcmd:opacity-100 hover:(text-fg border-border-hover) active:scale-95 focus-visible:(opacity-100) ring-focus-visible select-none"
