...
export default defineConfig({
  ...
  shortcuts: [
    ...
    // Focus states - ring for input / select etc.
    ['ring-focus-visible', 'focus:outline-none focus-visible:(ring-2 ring-accent)'],
    // Focus state - inset ring
    ['inset-focus-visible', 'focus:outline-none focus-visible:(inset-ring-2 inset-ring-accent)'],
    // Focus state - outline
    ['outline-focus-visible', 'focus-visible:(outline-2 outline-accent outline-offset-2)'],
    // Focus shadow for input
    ['input-focus-shadow', 'focus-visible:(dark:shadow-[0_0_10px_var(--accent)])'],
    // Focus state - enable.
    ['enable-focus-visible', 'outline-none focus-visible:(ring-2 ring-accent border-none!)'],
    // Focus state for custom card
    ['card-focus-visible', 'outline-none focus-visible:(bg-accent/50! text-accent!)'],
    // Focus state for search card
    [
      'search-card-foucs-visible',
      'focus-within:(ring-2 ring-accent bg-bg-muted dark:shadow-[0_0_15px_var(--accent)])',
    ],
